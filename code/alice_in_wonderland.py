...
print("Downloading and processing Alice In Wonderland from Github...")

result = lx.extract(
    text_or_documents="https://raw.githubusercontent.com/suddeb/langextract/main/data/aliceinwonderland.txt",
...
# Define output paths
OUTPUT_JSONL_FILENAME = "alice_in_wonderland_extraction_results.jsonl"
OUTPUT_HTML_FILENAME = "alice_in_wonderland_visualization.html"
