...
result = lx.extract(
    text_or_documents="https://github.com/suddeb/langextract/blob/main/data/aliceinwonderland.txt",
...
OUTPUT_PATH = "test_output/alice_in_wonderland_visualization.html"
